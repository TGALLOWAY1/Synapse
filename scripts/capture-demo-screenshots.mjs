...
const ARTIFACTS = [
    ...
    { slug: 'data-model', label: 'Data Model' },
    {
        ...
        tabs: {
            ...
            desktopOnly: true,
            items: [
                { slug: 'overview', label: 'Build Brief' },
                { slug: 'milestones', label: 'Roadmap' },
                { slug: 'prompt-packs', label: 'Prompts' },
                { slug: 'quality-gates', label: 'Validation' },
                { slug: 'traceability', label: 'Coverage' },
            ],
        },
    },
