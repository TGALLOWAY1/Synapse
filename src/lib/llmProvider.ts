import type { StructuredPRD, Milestone, AgentTarget, MockupSettings, CoreArtifactSubtype, ScreenInventoryContent, DataModelContent, ComponentInventoryContent } from '../types';
